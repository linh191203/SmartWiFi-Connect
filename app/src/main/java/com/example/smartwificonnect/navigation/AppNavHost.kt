...
import com.example.smartwificonnect.feature.review.ReviewScreen
    ...
    NavHost(
            ...
            HistoryScreen(
                records = mainState.historyRecords,
                    statusMessage = mainState.statusMessage.let { msg ->
                        if (msg == "Sẵn sàng quét OCR WiFi") "" else msg
                    },
        ...
        composable(Routes.SETTINGS) {
            SettingsScreen(
                ...
                prefer5GhzEnabled = mainState.prefer5GhzEnabled,
                ...
                onPrefer5GhzChange = mainViewModel::onPrefer5GhzPreferenceChanged,
